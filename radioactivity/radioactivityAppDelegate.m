...
#import "radioactivityAppDelegate.h"
#import "UIMapViewController.h"


@implementation radioactivityAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	mapViewController = [[UIMapViewController alloc]init];
    mapViewController.title = @"Messpunkte";
